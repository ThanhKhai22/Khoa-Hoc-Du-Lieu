...
l_page_url = "https://tiki.vn/api/v2/products?limit=48&include=advertisement&aggregations=2&trackity_id=7ac7bd0c-d274-5d0e-12e8-2c461a9e0820&q=s&page={}"
...
def crawl_product_id():
    ...
    while (True):
        print("Crawl page: ", i)
        print(l_page_url.format(i))
        response = requests.get(l_page_url.format(i), headers=headers)
